#!/usr/bin/env python3
"""
Script para eliminar columnas en español de mensaje_swift_readmodel
"""
...
def drop_columns(connection):
    """Eliminar columnas en español de mensaje_swift_readmodel"""
    cursor = connection.cursor()

    print("\n" + "=" * 80)
    print("ELIMINANDO COLUMNAS EN ESPAÑOL DE mensaje_swift_readmodel")
    print("=" * 80 + "\n")
    ...
    for column_name in SPANISH_COLUMNS:
        try:
            ...
            if result and result[0] > 0:
                sql = f"ALTER TABLE mensaje_swift_readmodel DROP COLUMN {column_name}"
