#!/usr/bin/env python3
"""
Script para agregar columnas faltantes en lc_payment_readmodel
"""
...
def add_missing_columns(connection):
    ...
    print("\n" + "=" * 80)
    print("AGREGANDO COLUMNAS FALTANTES A lc_payment_readmodel")
    print("=" * 80 + "\n")

    columns_to_add = [
        ("term_days", "INT"),
        ("discount_rate", "DECIMAL(8,4)"),
        ("bank_charges", "DECIMAL(18,2)"),
    ...
    for column_name, column_type in columns_to_add:
        try:
            ...
            cursor.execute(f"""
                ALTER TABLE lc_payment_readmodel
