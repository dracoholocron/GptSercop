#!/usr/bin/env python3
"""
Script para listar todas las columnas de financiamiento_cx_readmodel
"""
...
def list_columns(connection):
    """Listar todas las columnas de financiamiento_cx_readmodel"""
    ...
    print("\n" + "=" * 80)
    print("COLUMNAS DE financiamiento_cx_readmodel")
    print("=" * 80 + "\n")
