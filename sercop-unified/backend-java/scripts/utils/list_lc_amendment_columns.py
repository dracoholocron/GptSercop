#!/usr/bin/env python3
"""
Script para listar todas las columnas de lc_amendment_readmodel
"""
...
def list_columns(connection):
    """Listar todas las columnas de lc_amendment_readmodel"""
    ...
    print("\n" + "=" * 80)
    print("COLUMNAS DE lc_amendment_readmodel")
    print("=" * 80 + "\n")
