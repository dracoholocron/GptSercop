#!/usr/bin/env python3
"""
Script para listar todas las columnas de lc_negotiation_readmodel
"""
...
def list_columns(connection):
    """Listar todas las columnas de lc_negotiation_readmodel"""
    ...
    print("\n" + "=" * 80)
    print("COLUMNAS DE lc_negotiation_readmodel")
    print("=" * 80 + "\n")
