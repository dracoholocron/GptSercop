#!/usr/bin/env python3
"""
Script para listar todas las columnas de linea_credito_readmodel
"""
...
def list_columns(connection):
    """Listar todas las columnas de linea_credito_readmodel"""
    ...
    print("\n" + "=" * 80)
    print("COLUMNAS DE linea_credito_readmodel")
    print("=" * 80 + "\n")
