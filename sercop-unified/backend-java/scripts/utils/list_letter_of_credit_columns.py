#!/usr/bin/env python3
"""
Script para listar todas las columnas de letter_of_credit_readmodel
"""
...
def list_columns(connection):
    """Listar todas las columnas de letter_of_credit_readmodel"""
    ...
    print("\n" + "=" * 80)
    print("COLUMNAS DE letter_of_credit_readmodel")
    print("=" * 80 + "\n")
