#!/usr/bin/env python3
"""
Script para listar todas las columnas de swift_message_readmodel
"""
...
def list_columns(connection):
    """Listar todas las columnas de swift_message_readmodel"""
    ...
    cursor.execute("""
        ...
        AND TABLE_NAME = 'swift_message_readmodel'
        ORDER BY ORDINAL_POSITION
    """)

    print("\n" + "=" * 80)
    print("COLUMNAS DE swift_message_readmodel")
    print("=" * 80 + "\n")
