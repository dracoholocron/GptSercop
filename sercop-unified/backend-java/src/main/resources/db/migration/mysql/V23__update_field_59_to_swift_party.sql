-- ==================================================
-- Migración V23: Actualizar campo :59: a componente SWIFT_PARTY
-- ==================================================
-- Actualiza el campo :59: (Beneficiario/Beneficiary) del MT700
...
-- Actualizar campo :59: para ambos idiomas
UPDATE swift_field_config_readmodel
SET
    component_type = 'SWIFT_PARTY',
    field_type = 'SWIFT_PARTY',
    placeholder = CASE
        WHEN language = 'es' THEN 'Seleccione un beneficiario o ingrese manualmente'
        WHEN language = 'en' THEN 'Select a beneficiary or enter manually'
        ELSE placeholder
    END,
    help_text = CASE
