...
@NoArgsConstructor
public class DocumentaryCollectionUpdatedEvent extends DomainEvent {
    ...
    public DocumentaryCollectionUpdatedEvent(Long cobranzaId, String numeroOperacion, String tipo,
                                             String modalidad, String estado, String moneda,
                                             BigDecimal monto, String performedBy) {
        super("COBRANZA_DOCUMENTARIA_UPDATED", performedBy);
