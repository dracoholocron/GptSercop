...
public class LineaCreditoUpdatedEvent extends DomainEvent {
    ...
    public LineaCreditoUpdatedEvent(Long lineaCreditoId, Long clienteId, String tipo, String moneda,
        ...
        super("LINEA_CREDITO_UPDATED", performedBy);
