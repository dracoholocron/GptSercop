...
@NoArgsConstructor
public class ParticipanteUpdatedEvent extends DomainEvent {
    ...
    public ParticipanteUpdatedEvent(Long participanteId, String identificacion, String tipo,
        ...
        super("PARTICIPANTE_UPDATED", performedBy);
