...
@NoArgsConstructor
public class LetterOfCreditUpdatedEvent extends DomainEvent {
    ...
    public LetterOfCreditUpdatedEvent(Long cartaCreditoId, String numeroOperacion,
                                     String estado, BigDecimal montoUtilizado,
                                     String performedBy) {
        super("CARTA_CREDITO_UPDATED", performedBy);
