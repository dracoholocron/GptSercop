...
@NoArgsConstructor
public class BankGuaranteeUpdatedEvent extends DomainEvent {
    ...
    public BankGuaranteeUpdatedEvent(Long garantiaId, String numeroGarantia, String tipo,
                                        ...
                                        String performedBy) {
        super("GARANTIA_BANCARIA_UPDATED", performedBy);
