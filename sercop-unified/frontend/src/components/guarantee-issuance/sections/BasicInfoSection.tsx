...
/**
 * Sección de Información Básica para Garantías (Paso 1)
 * Renderiza campos SWIFT de la sección: BASICA
 */
      ...
      {mode === 'wizard' && (
        <Box>
          ...
          <Text color={colors.textColorSecondary} fontSize="sm">
            Ingrese los datos generales de la garantía bancaria
          </Text>
        </Box>
      )}
            ...
            <Flex gap={3}>
              ...
              <Box>
                ...
                <Text color={colors.textColorSecondary} fontSize="xs" mt={1}>
                  Es un compromiso irrevocable del banco emisor de pagar al beneficiario si el solicitante
                  incumple sus obligaciones contractuales. Existen varios tipos: Performance Bond (garantía de cumplimiento),
                  Payment Guarantee (garantía de pago), Advance Payment (anticipo), entre otros.
                </Text>
              </Box>
            </Flex>
          </Card.Body>
