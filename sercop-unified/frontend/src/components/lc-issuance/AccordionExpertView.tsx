...
const LC_IMPORT_ICONS: Record<string, IconType> = {
  'BASICA': FiFileText,
  'MONTOS': FiDollarSign,
  'FECHAS': FiCalendar,
  'PARTES': FiUsers,
...
const LC_IMPORT_COLORS: Record<string, string> = {
  'BASICA': 'blue',
  'MONTOS': 'green',
  'FECHAS': 'purple',
  'PARTES': 'orange',
...
export const AccordionExpertView: React.FC<AccordionExpertViewProps> = (props) => (
  <SharedAccordionExpertView
    ...
    sectionIcons={LC_IMPORT_ICONS}
    sectionColors={LC_IMPORT_COLORS}
