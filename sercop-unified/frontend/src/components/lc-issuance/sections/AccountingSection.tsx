...
/**
 * Sección de Asientos Contables (Paso 7)
  ...
  useEffect(() => {
    const loadExchangeRate = async () => {
      ...
      try {
        ...
        // Obtener todas las cotizaciones de la moneda y usar la más reciente
    ...
    <VStack gap={6} align="stretch">
      {mode === 'wizard' && (
        <Box>
          <Heading size="lg" color={colors.textColor} mb={2}>
            {t('common.stepHeader', { number: 7, name: t('lcImportWizard.steps.accounting') })}
          </Heading>
          <Text color={colors.textColorSecondary} fontSize="sm">
            {t('common.reviewAccountingEntries')}
          </Text>
        </Box>
      )}
      ...
      {mode === 'expert' && (
        <Box pb={2} mb={4} borderBottom="1px solid" borderColor={colors.borderColor}>
          <Heading size="md" color={colors.textColor}>
            {t('lcImportWizard.steps.accounting')}
          </Heading>
        </Box>
      )}
        ...
        <Card.Body p={4}>
          <VStack align="stretch" gap={3}>
            <Flex justify="space-between">
              ...
              <Badge colorPalette="blue">MT700 - Carta de Crédito Importación</Badge>
            </Flex>
            <Flex justify="space-between">
              <Text fontSize="sm" color={colors.textColorSecondary}>Evento:</Text>
              <Badge colorPalette="purple">EMISSION_LC_IMPORT</Badge>
            </Flex>
            <Flex justify="space-between">
        ...
        <Card.Root bg={colors.bgColor} border="1px" borderColor={colors.borderColor}>
          <Card.Body p={6}>
            <VStack gap={3}>
              ...
              <Progress.Root value={null} size="sm" colorPalette="blue" width="100%">
      ...
      {accountingEntry && !loadingAccountingEntry && (
        <AccountingEntryViewer
          ...
          commissionEvent={isCommissionDeferred ? 'DEFERRED_COMMISSION_LC_IMPORT' : 'COMMISSION_CHARGE_LC_IMPORT'}
        />
      )}
            ...
            <Flex gap={3}>
              ...
              <Box>
                ...
                <Text color={colors.textColorSecondary} fontSize="xs" mt={1}>
                  ...
                  El asiento mostrado arriba es una vista previa que se guardará en estado DRAFT al crear la carta de crédito.
