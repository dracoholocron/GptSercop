/** Config Tailwind en JS para que PostCSS la cargue sin depender de TypeScript */
const path = require('path');
const { colors, shadows, radii, fontSize } = require(path.join(__dirname, '../../packages/design-system/src/tokens.js'));
...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: { sm: shadows.sm, md: shadows.md, lg: shadows.lg },
